...
\begin{figure}[ht]
\begin{center}
  \epsfig{file=fig_RtSIM.png,height=2in}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \epsfig{file=fig_empirical_onset_dist.png,height=2in}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \epsfig{file=fig_weibull.png,height=2in}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \epsfig{file=fig_onset_now_ZA.png,width=4in}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \epsfig{file=fig_rt_inf_za.png,width=4in}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \epsfig{file=fig_rt_inf_prov.png, height=6in}
\end{center}
...
\begin{figure}[H]
\begin{center}
\epsfig{file=fig_rt_za.png,width=3in}
  \epsfig{file=fig_heerden.png,width=3in}
\end{center}
